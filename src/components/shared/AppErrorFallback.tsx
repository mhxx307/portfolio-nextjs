...
const AppErrorFallback = ({
    ...
    return (
        <Section className="flex min-h-screen w-full flex-col items-center justify-center py-4 md:py-20 ">
            <div className="bg-background-800 w-full p-8">
                <h1 className="mb-4 text-5xl font-semibold">
                    An Error Occurred
                </h1>
                <p className="mb-1 text-lg">
                    The application detected an error, and it&apos;s been
                    reported to the application development team. You can try
                    clicking &quot;Reload the Page&quot; to return to the page
                    you were on previously.
                </p>
                <p className="text-lg">
                    If the error keeps occurring, please file a bug report with
                    the following details, and include any steps to reproduce
                    the issue:
                </p>
                ...
                <details>
                    <summary className="mb-4">
                        Expand to Show Error Stack Traces
                    </summary>
